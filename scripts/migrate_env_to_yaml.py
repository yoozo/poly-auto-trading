...
def env_mappings() -> list[tuple[str, tuple[str, ...], Callable[[str], Any]]]:
    return [
        ...
        ("BINANCE_WS_ADAPTIVE_ENABLED", ("binance", "ws_adaptive_enabled"), bool_value),
        ("BINANCE_WS_PROBE_INTERVAL_SECONDS", ("binance", "ws_probe_interval_seconds"), int),
        ("BINANCE_WS_PROBE_TIMEOUT_SECONDS", ("binance", "ws_probe_timeout_seconds"), float),
